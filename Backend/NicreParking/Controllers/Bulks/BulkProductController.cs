...
namespace webApi.Controllers.Bulks
{
    ...
    public class BulkProductController : ControllerBase
    {
        ...
        public BulkProductController(IBulkService bulkService, IHostingEnvironment hostingEnvironment)
        {
        ...
        public async Task<IActionResult> ExcelUpload(IFormFile file)
        {
            ...
            var excelUploadResponse = _bulkService.LoadProductsExcell(filePath);
