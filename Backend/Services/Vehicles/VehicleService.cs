...
namespace Services.Vehicles
{
    public class VehicleService : IVehicleService
    {
        ...
        private readonly IRepository<MonthlyClient> _clientRepository;
        ...
        public VehicleService(
            IMapper mapper,
            IRepository<MonthlyClient> clientRepository,
        ...
        public IEnumerable<VehicleDto> GetActiveVehiclesBy(int clientId)
        {
            ...
            _nullEntityValidator.Validate<MonthlyClient>(client, "Cliente");
        ...
        public VehicleDto CreateVehicle(VehicleCreateDto vehicleCreate)
        {
            ...
            var client = _clientRepository.List().FirstOrDefault(c => vehicleCreate.ClientId == c.Id);
            _vehicleCreateValidator.ValidateExistingClient(client, vehicleCreate);

            var vehicle = _vehicleGenerator.Generate(vehicleCreate, client);
